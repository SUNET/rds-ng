...
def create_project_jobs_service(comp: ServerComponent) -> Service:
    ...
    @svc.message_handler(ListProjectJobsCommand, is_async=False)
    ...
    @svc.message_handler(InitiateProjectJobCommand, is_async=False)
    ...
    @svc.message_handler(StartProjectJobReply, is_async=False)
    ...
    @svc.message_handler(ProjectJobProgressEvent, is_async=False)
    ...
    @svc.message_handler(ProjectJobCompletionEvent, is_async=False)
    def job_completion(
