---
id: "common_web_api_project_ProjectEvents.ProjectLogbookEvent"
title: "Class: ProjectLogbookEvent"
sidebar_label: "ProjectLogbookEvent"
custom_edit_url: null
---

[common/web/api/project/ProjectEvents](../modules/common_web_api_project_ProjectEvents.md).ProjectLogbookEvent
...
• **new ProjectLogbookEvent**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ProjectLogbookEvent`](common_web_api_project_ProjectEvents.ProjectLogbookEvent.md)
...
[src/common/web/api/project/ProjectEvents.ts:61](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectEvents.ts#L61)
...
[src/common/web/api/project/ProjectEvents.ts:57](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectEvents.ts#L57)
...
▸ **build**(`messageBuilder`, `projectID`, `logbook`, `chain?`): [`EventComposer`](common_web_core_messaging_composers_EventComposer.EventComposer.md)<[`ProjectLogbookEvent`](common_web_api_project_ProjectEvents.ProjectLogbookEvent.md)\>
...
[src/common/web/api/project/ProjectEvents.ts:66](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectEvents.ts#L66)
