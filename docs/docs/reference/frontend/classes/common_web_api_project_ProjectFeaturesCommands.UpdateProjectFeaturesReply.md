...
• **new UpdateProjectFeaturesReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`UpdateProjectFeaturesReply`](common_web_api_project_ProjectFeaturesCommands.UpdateProjectFeaturesReply.md)
...
[src/common/web/api/project/ProjectFeaturesCommands.ts:70](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectFeaturesCommands.ts#L70)
...
[src/common/web/api/project/ProjectFeaturesCommands.ts:74](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectFeaturesCommands.ts#L74)
...
[src/common/web/api/project/ProjectFeaturesCommands.ts:79](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectFeaturesCommands.ts#L79)
