---
id: "common_web_api_project_ProjectEvents.ProjectExternalStateEvent"
title: "Class: ProjectExternalStateEvent"
sidebar_label: "ProjectExternalStateEvent"
custom_edit_url: null
---

[common/web/api/project/ProjectEvents](../modules/common_web_api_project_ProjectEvents.md).ProjectExternalStateEvent
...
The new project's external state.
...
• **new ProjectExternalStateEvent**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ProjectExternalStateEvent`](common_web_api_project_ProjectEvents.ProjectExternalStateEvent.md)
...
[src/common/web/api/project/ProjectEvents.ts:88](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectEvents.ts#L88)

___

### external\_state

• `Readonly` **external\_state**: [`ProjectExternalState`](common_web_data_entities_project_ProjectExternalState.ProjectExternalState.md)

#### Defined in

[src/common/web/api/project/ProjectEvents.ts:92](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectEvents.ts#L92)
...
[src/common/web/api/project/ProjectEvents.ts:86](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectEvents.ts#L86)
...
[src/common/web/api/project/ProjectEvents.ts:87](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectEvents.ts#L87)
...
▸ **build**(`messageBuilder`, `userID`, `projectID`, `connector_instance`, `external_state`, `chain?`): [`EventComposer`](common_web_core_messaging_composers_EventComposer.EventComposer.md)<[`ProjectLogbookEvent`](common_web_api_project_ProjectEvents.ProjectLogbookEvent.md)\>
...
| `connector_instance` | `string` | `undefined` |
| `external_state` | [`ProjectExternalState`](common_web_data_entities_project_ProjectExternalState.ProjectExternalState.md) | `undefined` |
| `chain` | ``null`` \| [`Message`](common_web_core_messaging_Message.Message.md) | `null` |

#### Returns

[`EventComposer`](common_web_core_messaging_composers_EventComposer.EventComposer.md)<[`ProjectLogbookEvent`](common_web_api_project_ProjectEvents.ProjectLogbookEvent.md)\>

#### Defined in

[src/common/web/api/project/ProjectEvents.ts:97](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectEvents.ts#L97)
