---
id: "common_web_api_project_ProjectExportersCommands.ListProjectExportersReply"
title: "Class: ListProjectExportersReply"
sidebar_label: "ListProjectExportersReply"
custom_edit_url: null
---

[common/web/api/project/ProjectExportersCommands](../modules/common_web_api_project_ProjectExportersCommands.md).ListProjectExportersReply

Reply to ``Reply to ``ListProjectsCommand``.``.

**`Param`**

List of all project exporters.
...
• **new ListProjectExportersReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ListProjectExportersReply`](common_web_api_project_ProjectExportersCommands.ListProjectExportersReply.md)
...
[`ListProjectExportersReply`](common_web_api_project_ProjectExportersCommands.ListProjectExportersReply.md)
...
• `Readonly` **exporters**: [`ProjectExporterDescriptor`](common_web_data_exporters_ProjectExporterDescriptor.ProjectExporterDescriptor.md)[] = `[]`

#### Defined in

[src/common/web/api/project/ProjectExportersCommands.ts:35](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectExportersCommands.ts#L35)
...
▸ **build**(`messageBuilder`, `cmd`, `exporters`, `success?`, `message?`): [`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`ListProjectExportersReply`](common_web_api_project_ProjectExportersCommands.ListProjectExportersReply.md)\>
...
| `cmd` | [`ListProjectExportersCommand`](common_web_api_project_ProjectExportersCommands.ListProjectExportersCommand.md) | `undefined` |
| `exporters` | [`ProjectExporterDescriptor`](common_web_data_exporters_ProjectExporterDescriptor.ProjectExporterDescriptor.md)[] | `undefined` |
| `success` | `boolean` | `true` |
| `message` | `string` | `""` |

#### Returns

[`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`ListProjectExportersReply`](common_web_api_project_ProjectExportersCommands.ListProjectExportersReply.md)\>

#### Defined in

[src/common/web/api/project/ProjectExportersCommands.ts:40](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectExportersCommands.ts#L40)
