...
• **new ClientDisconnectedEvent**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ClientDisconnectedEvent`](common_web_api_network_NetworkEvents.ClientDisconnectedEvent.md)
...
[src/common/web/api/network/NetworkEvents.ts:30](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/network/NetworkEvents.ts#L30)
