---
id: "common_web_api_session_SessionCommands.SetSessionValueCommand"
title: "Class: SetSessionValueCommand"
sidebar_label: "SetSessionValueCommand"
custom_edit_url: null
---

[common/web/api/session/SessionCommands](../modules/common_web_api_session_SessionCommands.md).SetSessionValueCommand
...
• **new SetSessionValueCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`SetSessionValueCommand`](common_web_api_session_SessionCommands.SetSessionValueCommand.md)
...
[src/common/web/api/session/SessionCommands.ts:55](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/session/SessionCommands.ts#L55)
...
[src/common/web/api/session/SessionCommands.ts:56](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/session/SessionCommands.ts#L56)
...
▸ **build**(`messageBuilder`, `key`, `value`, `chain?`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`SetSessionValueCommand`](common_web_api_session_SessionCommands.SetSessionValueCommand.md)\>
...
[`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`SetSessionValueCommand`](common_web_api_session_SessionCommands.SetSessionValueCommand.md)\>

#### Defined in

[src/common/web/api/session/SessionCommands.ts:61](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/session/SessionCommands.ts#L61)
