---
id: "common_web_api_resource_ResourceCommands.AssignResourcesBrokerReply"
title: "Class: AssignResourcesBrokerReply"
sidebar_label: "AssignResourcesBrokerReply"
custom_edit_url: null
---

[common/web/api/resource/ResourceCommands](../modules/common_web_api_resource_ResourceCommands.md).AssignResourcesBrokerReply
...
• **new AssignResourcesBrokerReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`AssignResourcesBrokerReply`](common_web_api_resource_ResourceCommands.AssignResourcesBrokerReply.md)
...
▸ **build**(`messageBuilder`, `cmd`, `success?`, `message?`): [`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`AssignResourcesBrokerReply`](common_web_api_resource_ResourceCommands.AssignResourcesBrokerReply.md)\>
...
| `cmd` | [`AssignResourcesBrokerCommand`](common_web_api_resource_ResourceCommands.AssignResourcesBrokerCommand.md) | `undefined` |
| `success` | `boolean` | `true` |
| `message` | `string` | `""` |

#### Returns

[`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`AssignResourcesBrokerReply`](common_web_api_resource_ResourceCommands.AssignResourcesBrokerReply.md)\>

#### Defined in

[src/common/web/api/resource/ResourceCommands.ts:44](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/resource/ResourceCommands.ts#L44)
