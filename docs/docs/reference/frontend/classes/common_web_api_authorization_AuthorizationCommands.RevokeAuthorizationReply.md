---
id: "common_web_api_authorization_AuthorizationCommands.RevokeAuthorizationReply"
title: "Class: RevokeAuthorizationReply"
sidebar_label: "RevokeAuthorizationReply"
custom_edit_url: null
---

[common/web/api/authorization/AuthorizationCommands](../modules/common_web_api_authorization_AuthorizationCommands.md).RevokeAuthorizationReply
...
• **new RevokeAuthorizationReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`RevokeAuthorizationReply`](common_web_api_authorization_AuthorizationCommands.RevokeAuthorizationReply.md)
...
▸ **build**(`messageBuilder`, `cmd`, `success?`, `message?`): [`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`RevokeAuthorizationReply`](common_web_api_authorization_AuthorizationCommands.RevokeAuthorizationReply.md)\>
...
| `cmd` | [`RevokeAuthorizationCommand`](common_web_api_authorization_AuthorizationCommands.RevokeAuthorizationCommand.md) | `undefined` |
| `success` | `boolean` | `true` |
| `message` | `string` | `""` |

#### Returns

[`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`RevokeAuthorizationReply`](common_web_api_authorization_AuthorizationCommands.RevokeAuthorizationReply.md)\>

#### Defined in

[src/common/web/api/authorization/AuthorizationCommands.ts:106](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/authorization/AuthorizationCommands.ts#L106)
