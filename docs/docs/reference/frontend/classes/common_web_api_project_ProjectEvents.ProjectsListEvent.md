...
• **new ProjectsListEvent**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ProjectsListEvent`](common_web_api_project_ProjectEvents.ProjectsListEvent.md)
...
[src/common/web/api/project/ProjectEvents.ts:22](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectEvents.ts#L22)
...
[src/common/web/api/project/ProjectEvents.ts:27](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectEvents.ts#L27)
