---
id: "common_web_api_project_ProjectExportersCommands.ExportProjectReply"
title: "Class: ExportProjectReply"
sidebar_label: "ExportProjectReply"
custom_edit_url: null
---

[common/web/api/project/ProjectExportersCommands](../modules/common_web_api_project_ProjectExportersCommands.md).ExportProjectReply

Reply to ``ExportProjectCommand``.

**`Param`**

The MIME type of the export result.
...
• **new ExportProjectReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ExportProjectReply`](common_web_api_project_ProjectExportersCommands.ExportProjectReply.md)
...
[`ExportProjectReply`](common_web_api_project_ProjectExportersCommands.ExportProjectReply.md)
...
[src/common/web/api/project/ProjectExportersCommands.ts:82](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectExportersCommands.ts#L82)
...
[src/common/web/api/project/ProjectExportersCommands.ts:87](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectExportersCommands.ts#L87)
...
| :------ | :------ | :------ |
| `data` | `ArrayBuffer` | The export result data. |
...
[src/common/web/api/project/ProjectExportersCommands.ts:99](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectExportersCommands.ts#L99)
...
▸ **build**(`messageBuilder`, `cmd`, `mimetype`, `data`, `success?`, `message?`): [`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`ExportProjectReply`](common_web_api_project_ProjectExportersCommands.ExportProjectReply.md)\>
...
| `cmd` | [`ExportProjectCommand`](common_web_api_project_ProjectExportersCommands.ExportProjectCommand.md) | `undefined` |
...
[`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`ExportProjectReply`](common_web_api_project_ProjectExportersCommands.ExportProjectReply.md)\>

#### Defined in

[src/common/web/api/project/ProjectExportersCommands.ts:106](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectExportersCommands.ts#L106)
