---
id: "common_web_api_resource_ResourceCommands.ListResourcesCommand"
title: "Class: ListResourcesCommand"
sidebar_label: "ListResourcesCommand"
custom_edit_url: null
---

[common/web/api/resource/ResourceCommands](../modules/common_web_api_resource_ResourceCommands.md).ListResourcesCommand
...
• **new ListResourcesCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ListResourcesCommand`](common_web_api_resource_ResourceCommands.ListResourcesCommand.md)
...
[src/common/web/api/resource/ResourceCommands.ts:67](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/resource/ResourceCommands.ts#L67)
...
[src/common/web/api/resource/ResourceCommands.ts:66](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/resource/ResourceCommands.ts#L66)
...
[src/common/web/api/resource/ResourceCommands.ts:69](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/resource/ResourceCommands.ts#L69)
...
[src/common/web/api/resource/ResourceCommands.ts:64](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/resource/ResourceCommands.ts#L64)
...
▸ **build**(`messageBuilder`, `root?`, `includeFolders?`, `includeFiles?`, `recursive?`, `chain?`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`ListResourcesCommand`](common_web_api_resource_ResourceCommands.ListResourcesCommand.md)\>
...
[src/common/web/api/resource/ResourceCommands.ts:74](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/resource/ResourceCommands.ts#L74)
