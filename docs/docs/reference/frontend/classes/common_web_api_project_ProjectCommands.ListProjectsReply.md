...
• **new ListProjectsReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ListProjectsReply`](common_web_api_project_ProjectCommands.ListProjectsReply.md)
...
• `Readonly` **projects**: [`Project`](common_web_data_entities_project_Project.Project.md)[] = `[]`

#### Defined in

[src/common/web/api/project/ProjectCommands.ts:36](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectCommands.ts#L36)
...
| `projects` | [`Project`](common_web_data_entities_project_Project.Project.md)[] | `undefined` |
...
[src/common/web/api/project/ProjectCommands.ts:41](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectCommands.ts#L41)
