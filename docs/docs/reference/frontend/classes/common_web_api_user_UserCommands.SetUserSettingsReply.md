---
id: "common_web_api_user_UserCommands.SetUserSettingsReply"
title: "Class: SetUserSettingsReply"
sidebar_label: "SetUserSettingsReply"
custom_edit_url: null
---

[common/web/api/user/UserCommands](../modules/common_web_api_user_UserCommands.md).SetUserSettingsReply

Reply to ``SetUserSettingsCommand``.

**`Param`**

The new user settings (note that these might have been adjusted by the server).
...
• **new SetUserSettingsReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`SetUserSettingsReply`](common_web_api_user_UserCommands.SetUserSettingsReply.md)
...
• `Readonly` **settings**: [`UserSettings`](common_web_data_entities_user_UserSettings.UserSettings.md)

#### Defined in

[src/common/web/api/user/UserCommands.ts:120](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/user/UserCommands.ts#L120)
...
▸ **build**(`messageBuilder`, `cmd`, `settings`, `success?`, `message?`): [`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`SetUserSettingsReply`](common_web_api_user_UserCommands.SetUserSettingsReply.md)\>
...
| `cmd` | [`SetUserSettingsCommand`](common_web_api_user_UserCommands.SetUserSettingsCommand.md) | `undefined` |
| `settings` | [`UserSettings`](common_web_data_entities_user_UserSettings.UserSettings.md) | `undefined` |
| `success` | `boolean` | `true` |
| `message` | `string` | `""` |

#### Returns

[`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`SetUserSettingsReply`](common_web_api_user_UserCommands.SetUserSettingsReply.md)\>

#### Defined in

[src/common/web/api/user/UserCommands.ts:125](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/user/UserCommands.ts#L125)
