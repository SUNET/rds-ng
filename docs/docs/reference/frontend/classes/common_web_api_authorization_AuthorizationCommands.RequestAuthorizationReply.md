---
id: "common_web_api_authorization_AuthorizationCommands.RequestAuthorizationReply"
title: "Class: RequestAuthorizationReply"
sidebar_label: "RequestAuthorizationReply"
custom_edit_url: null
---

[common/web/api/authorization/AuthorizationCommands](../modules/common_web_api_authorization_AuthorizationCommands.md).RequestAuthorizationReply
...
• **new RequestAuthorizationReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`RequestAuthorizationReply`](common_web_api_authorization_AuthorizationCommands.RequestAuthorizationReply.md)
...
▸ **build**(`messageBuilder`, `cmd`, `success?`, `message?`): [`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`RequestAuthorizationReply`](common_web_api_authorization_AuthorizationCommands.RequestAuthorizationReply.md)\>
...
| `cmd` | [`RequestAuthorizationCommand`](common_web_api_authorization_AuthorizationCommands.RequestAuthorizationCommand.md) | `undefined` |
| `success` | `boolean` | `true` |
| `message` | `string` | `""` |

#### Returns

[`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`RequestAuthorizationReply`](common_web_api_authorization_AuthorizationCommands.RequestAuthorizationReply.md)\>

#### Defined in

[src/common/web/api/authorization/AuthorizationCommands.ts:60](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/authorization/AuthorizationCommands.ts#L60)
