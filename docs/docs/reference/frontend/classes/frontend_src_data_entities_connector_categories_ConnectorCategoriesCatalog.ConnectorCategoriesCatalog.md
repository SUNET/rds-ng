---
id: "frontend_src_data_entities_connector_categories_ConnectorCategoriesCatalog.ConnectorCategoriesCatalog"
title: "Class: ConnectorCategoriesCatalog"
sidebar_label: "ConnectorCategoriesCatalog"
custom_edit_url: null
---

[frontend/src/data/entities/connector/categories/ConnectorCategoriesCatalog](../modules/frontend_src_data_entities_connector_categories_ConnectorCategoriesCatalog.md).ConnectorCategoriesCatalog

Global catalog of all supported authentication schemes.

## Hierarchy

- [`ItemsCatalog`](common_web_utils_ItemsCatalog.ItemsCatalog.md)<[`ConnectorCategory`](frontend_src_data_entities_connector_categories_ConnectorCategory.ConnectorCategory.md)\>

  ↳ **`ConnectorCategoriesCatalog`**

## Constructors

### constructor

• **new ConnectorCategoriesCatalog**(): [`ConnectorCategoriesCatalog`](frontend_src_data_entities_connector_categories_ConnectorCategoriesCatalog.ConnectorCategoriesCatalog.md)

#### Returns

[`ConnectorCategoriesCatalog`](frontend_src_data_entities_connector_categories_ConnectorCategoriesCatalog.ConnectorCategoriesCatalog.md)
