---
id: "common_web_api_resource_ResourceCommands.ListResourcesReply"
title: "Class: ListResourcesReply"
sidebar_label: "ListResourcesReply"
custom_edit_url: null
---

[common/web/api/resource/ResourceCommands](../modules/common_web_api_resource_ResourceCommands.md).ListResourcesReply
...
• **new ListResourcesReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ListResourcesReply`](common_web_api_resource_ResourceCommands.ListResourcesReply.md)
...
• `Readonly` **resources**: [`ResourcesList`](common_web_data_entities_resource_ResourcesList.ResourcesList.md)

#### Defined in

[src/common/web/api/resource/ResourceCommands.ts:99](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/resource/ResourceCommands.ts#L99)
...
▸ **build**(`messageBuilder`, `cmd`, `resources`, `success?`, `message?`): [`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`ListResourcesReply`](common_web_api_resource_ResourceCommands.ListResourcesReply.md)\>
...
| `cmd` | [`ListResourcesCommand`](common_web_api_resource_ResourceCommands.ListResourcesCommand.md) | `undefined` |
| `resources` | [`ResourcesList`](common_web_data_entities_resource_ResourcesList.ResourcesList.md) | `undefined` |
| `success` | `boolean` | `true` |
| `message` | `string` | `""` |

#### Returns

[`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`ListResourcesReply`](common_web_api_resource_ResourceCommands.ListResourcesReply.md)\>

#### Defined in

[src/common/web/api/resource/ResourceCommands.ts:104](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/resource/ResourceCommands.ts#L104)
