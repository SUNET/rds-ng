---
id: "frontend_src_ui_actions_project_MarkProjectLogbookSeenAction.MarkProjectLogbookSeenAction"
title: "Class: MarkProjectLogbookSeenAction"
sidebar_label: "MarkProjectLogbookSeenAction"
custom_edit_url: null
---

[frontend/src/ui/actions/project/MarkProjectLogbookSeenAction](../modules/frontend_src_ui_actions_project_MarkProjectLogbookSeenAction.md).MarkProjectLogbookSeenAction

Action to mark a project logbook entry as seen.

## Hierarchy

- [`FrontendCommandAction`](frontend_src_ui_actions_FrontendCommandAction.FrontendCommandAction.md)<[`MarkProjectLogbookSeenCommand`](common_web_api_project_ProjectCommands.MarkProjectLogbookSeenCommand.md), [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`MarkProjectLogbookSeenCommand`](common_web_api_project_ProjectCommands.MarkProjectLogbookSeenCommand.md)\>\>

  ↳ **`MarkProjectLogbookSeenAction`**

## Constructors

### constructor

• **new MarkProjectLogbookSeenAction**(`comp`, `suppressDefaultNotifiers?`): [`MarkProjectLogbookSeenAction`](frontend_src_ui_actions_project_MarkProjectLogbookSeenAction.MarkProjectLogbookSeenAction.md)
...
• `Protected` **\_composer**: ``null`` \| [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`MarkProjectLogbookSeenCommand`](common_web_api_project_ProjectCommands.MarkProjectLogbookSeenCommand.md)\> = `null`
...
[src/frontend/src/ui/actions/project/MarkProjectLogbookSeenAction.ts:23](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/project/MarkProjectLogbookSeenAction.ts#L23)
...
▸ **completed**(`cb`): [`MarkProjectLogbookSeenAction`](frontend_src_ui_actions_project_MarkProjectLogbookSeenAction.MarkProjectLogbookSeenAction.md)
...
▸ **failed**(`cb`): [`MarkProjectLogbookSeenAction`](frontend_src_ui_actions_project_MarkProjectLogbookSeenAction.MarkProjectLogbookSeenAction.md)
...
▸ **prepare**(`logbookType`, `markAll`, `project?`, `record?`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`MarkProjectLogbookSeenCommand`](common_web_api_project_ProjectCommands.MarkProjectLogbookSeenCommand.md)\>
...
| Name | Type |
| :------ | :------ |
| `logbookType` | [`JobHistory`](../enums/common_web_data_entities_project_logbook_ProjectLogbookType.ProjectLogbookType.md#jobhistory) |
| `markAll` | `boolean` |
...
[src/frontend/src/ui/actions/project/MarkProjectLogbookSeenAction.ts:16](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/project/MarkProjectLogbookSeenAction.ts#L16)
