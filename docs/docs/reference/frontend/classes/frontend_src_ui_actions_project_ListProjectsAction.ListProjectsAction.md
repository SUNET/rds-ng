---
id: "frontend_src_ui_actions_project_ListProjectsAction.ListProjectsAction"
title: "Class: ListProjectsAction"
sidebar_label: "ListProjectsAction"
custom_edit_url: null
---

[frontend/src/ui/actions/project/ListProjectsAction](../modules/frontend_src_ui_actions_project_ListProjectsAction.md).ListProjectsAction
...
• **new ListProjectsAction**(`comp`, `suppressDefaultNotifiers?`): [`ListProjectsAction`](frontend_src_ui_actions_project_ListProjectsAction.ListProjectsAction.md)
...
[src/frontend/src/ui/actions/project/ListProjectsAction.ts:21](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/project/ListProjectsAction.ts#L21)
...
▸ **completed**(`cb`): [`ListProjectsAction`](frontend_src_ui_actions_project_ListProjectsAction.ListProjectsAction.md)
...
▸ **failed**(`cb`): [`ListProjectsAction`](frontend_src_ui_actions_project_ListProjectsAction.ListProjectsAction.md)
...
[src/frontend/src/ui/actions/project/ListProjectsAction.ts:14](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/project/ListProjectsAction.ts#L14)
