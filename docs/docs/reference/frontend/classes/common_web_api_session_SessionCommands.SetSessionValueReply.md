---
id: "common_web_api_session_SessionCommands.SetSessionValueReply"
title: "Class: SetSessionValueReply"
sidebar_label: "SetSessionValueReply"
custom_edit_url: null
---

[common/web/api/session/SessionCommands](../modules/common_web_api_session_SessionCommands.md).SetSessionValueReply
...
• **new SetSessionValueReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`SetSessionValueReply`](common_web_api_session_SessionCommands.SetSessionValueReply.md)
...
▸ **build**(`messageBuilder`, `cmd`, `success?`, `message?`): [`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`SetSessionValueReply`](common_web_api_session_SessionCommands.SetSessionValueReply.md)\>
...
| `cmd` | [`SetSessionValueCommand`](common_web_api_session_SessionCommands.SetSessionValueCommand.md) | `undefined` |
| `success` | `boolean` | `true` |
| `message` | `string` | `""` |

#### Returns

[`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`SetSessionValueReply`](common_web_api_session_SessionCommands.SetSessionValueReply.md)\>

#### Defined in

[src/common/web/api/session/SessionCommands.ts:76](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/session/SessionCommands.ts#L76)
