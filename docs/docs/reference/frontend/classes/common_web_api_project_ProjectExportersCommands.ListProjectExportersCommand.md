---
id: "common_web_api_project_ProjectExportersCommands.ListProjectExportersCommand"
title: "Class: ListProjectExportersCommand"
sidebar_label: "ListProjectExportersCommand"
custom_edit_url: null
---

[common/web/api/project/ProjectExportersCommands](../modules/common_web_api_project_ProjectExportersCommands.md).ListProjectExportersCommand
...
• **new ListProjectExportersCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ListProjectExportersCommand`](common_web_api_project_ProjectExportersCommands.ListProjectExportersCommand.md)
...
▸ **build**(`messageBuilder`, `chain?`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`ListProjectExportersCommand`](common_web_api_project_ProjectExportersCommands.ListProjectExportersCommand.md)\>
...
[src/common/web/api/project/ProjectExportersCommands.ts:21](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectExportersCommands.ts#L21)
