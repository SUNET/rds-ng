...
• **new UpdateProjectReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`UpdateProjectReply`](common_web_api_project_ProjectCommands.UpdateProjectReply.md)
...
[src/common/web/api/project/ProjectCommands.ts:155](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectCommands.ts#L155)
...
[src/common/web/api/project/ProjectCommands.ts:160](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectCommands.ts#L160)
