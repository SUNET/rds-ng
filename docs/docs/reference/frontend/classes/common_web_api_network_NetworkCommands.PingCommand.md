...
• **new PingCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`PingCommand`](common_web_api_network_NetworkCommands.PingCommand.md)
...
[src/common/web/api/network/NetworkCommands.ts:13](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/network/NetworkCommands.ts#L13)
...
[src/common/web/api/network/NetworkCommands.ts:18](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/network/NetworkCommands.ts#L18)
