...
• **new ClientConnectionErrorEvent**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ClientConnectionErrorEvent`](common_web_api_network_NetworkEvents.ClientConnectionErrorEvent.md)
...
[src/common/web/api/network/NetworkEvents.ts:42](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/network/NetworkEvents.ts#L42)
...
[src/common/web/api/network/NetworkEvents.ts:47](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/network/NetworkEvents.ts#L47)
