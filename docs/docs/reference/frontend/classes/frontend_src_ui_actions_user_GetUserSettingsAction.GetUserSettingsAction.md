---
id: "frontend_src_ui_actions_user_GetUserSettingsAction.GetUserSettingsAction"
title: "Class: GetUserSettingsAction"
sidebar_label: "GetUserSettingsAction"
custom_edit_url: null
---

[frontend/src/ui/actions/user/GetUserSettingsAction](../modules/frontend_src_ui_actions_user_GetUserSettingsAction.md).GetUserSettingsAction

Action to retrieve all connectors.

## Hierarchy

- [`FrontendCommandAction`](frontend_src_ui_actions_FrontendCommandAction.FrontendCommandAction.md)<[`GetUserSettingsCommand`](common_web_api_user_UserCommands.GetUserSettingsCommand.md), [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`GetUserSettingsCommand`](common_web_api_user_UserCommands.GetUserSettingsCommand.md)\>\>
...
• **new GetUserSettingsAction**(`comp`, `suppressDefaultNotifiers?`): [`GetUserSettingsAction`](frontend_src_ui_actions_user_GetUserSettingsAction.GetUserSettingsAction.md)
...
• `Protected` **\_composer**: ``null`` \| [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`GetUserSettingsCommand`](common_web_api_user_UserCommands.GetUserSettingsCommand.md)\> = `null`
...
[src/frontend/src/ui/actions/user/GetUserSettingsAction.ts:21](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/user/GetUserSettingsAction.ts#L21)
...
▸ **completed**(`cb`): [`GetUserSettingsAction`](frontend_src_ui_actions_user_GetUserSettingsAction.GetUserSettingsAction.md)
...
▸ **failed**(`cb`): [`GetUserSettingsAction`](frontend_src_ui_actions_user_GetUserSettingsAction.GetUserSettingsAction.md)
...
▸ **prepare**(): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`GetUserSettingsCommand`](common_web_api_user_UserCommands.GetUserSettingsCommand.md)\>

Prepares this action.

#### Returns

[`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`GetUserSettingsCommand`](common_web_api_user_UserCommands.GetUserSettingsCommand.md)\>
...
[src/frontend/src/ui/actions/user/GetUserSettingsAction.ts:14](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/user/GetUserSettingsAction.ts#L14)
