---
id: "frontend_src_ui_actions_project_ListProjectJobsAction.ListProjectJobsAction"
title: "Class: ListProjectJobsAction"
sidebar_label: "ListProjectJobsAction"
custom_edit_url: null
---

[frontend/src/ui/actions/project/ListProjectJobsAction](../modules/frontend_src_ui_actions_project_ListProjectJobsAction.md).ListProjectJobsAction

Action to retrieve all projects.

## Hierarchy

- [`FrontendCommandAction`](frontend_src_ui_actions_FrontendCommandAction.FrontendCommandAction.md)<[`ListProjectJobsCommand`](common_web_api_project_ProjectJobCommands.ListProjectJobsCommand.md), [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`ListProjectJobsCommand`](common_web_api_project_ProjectJobCommands.ListProjectJobsCommand.md)\>\>
...
• **new ListProjectJobsAction**(`comp`, `suppressDefaultNotifiers?`): [`ListProjectJobsAction`](frontend_src_ui_actions_project_ListProjectJobsAction.ListProjectJobsAction.md)
...
• `Protected` **\_composer**: ``null`` \| [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`ListProjectJobsCommand`](common_web_api_project_ProjectJobCommands.ListProjectJobsCommand.md)\> = `null`
...
[src/frontend/src/ui/actions/project/ListProjectJobsAction.ts:21](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/project/ListProjectJobsAction.ts#L21)
...
▸ **completed**(`cb`): [`ListProjectJobsAction`](frontend_src_ui_actions_project_ListProjectJobsAction.ListProjectJobsAction.md)
...
▸ **failed**(`cb`): [`ListProjectJobsAction`](frontend_src_ui_actions_project_ListProjectJobsAction.ListProjectJobsAction.md)
...
▸ **prepare**(): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`ListProjectJobsCommand`](common_web_api_project_ProjectJobCommands.ListProjectJobsCommand.md)\>

Prepares this action.

#### Returns

[`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`ListProjectJobsCommand`](common_web_api_project_ProjectJobCommands.ListProjectJobsCommand.md)\>
...
[src/frontend/src/ui/actions/project/ListProjectJobsAction.ts:14](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/project/ListProjectJobsAction.ts#L14)
