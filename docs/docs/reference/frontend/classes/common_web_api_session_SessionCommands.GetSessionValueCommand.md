---
id: "common_web_api_session_SessionCommands.GetSessionValueCommand"
title: "Class: GetSessionValueCommand"
sidebar_label: "GetSessionValueCommand"
custom_edit_url: null
---

[common/web/api/session/SessionCommands](../modules/common_web_api_session_SessionCommands.md).GetSessionValueCommand
...
• **new GetSessionValueCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`GetSessionValueCommand`](common_web_api_session_SessionCommands.GetSessionValueCommand.md)
...
[src/common/web/api/session/SessionCommands.ts:15](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/session/SessionCommands.ts#L15)
...
▸ **build**(`messageBuilder`, `key`, `chain?`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`GetSessionValueCommand`](common_web_api_session_SessionCommands.GetSessionValueCommand.md)\>
...
[src/common/web/api/session/SessionCommands.ts:20](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/session/SessionCommands.ts#L20)
