---
id: "common_web_api_user_UserCommands.GetUserSettingsReply"
title: "Class: GetUserSettingsReply"
sidebar_label: "GetUserSettingsReply"
custom_edit_url: null
---

[common/web/api/user/UserCommands](../modules/common_web_api_user_UserCommands.md).GetUserSettingsReply
...
• **new GetUserSettingsReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`GetUserSettingsReply`](common_web_api_user_UserCommands.GetUserSettingsReply.md)
...
[src/common/web/api/user/UserCommands.ts:76](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/user/UserCommands.ts#L76)
...
▸ **build**(`messageBuilder`, `cmd`, `settings`, `success?`, `message?`): [`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`GetUserSettingsReply`](common_web_api_user_UserCommands.GetUserSettingsReply.md)\>
...
| `cmd` | [`GetUserSettingsCommand`](common_web_api_user_UserCommands.GetUserSettingsCommand.md) | `undefined` |
...
[`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`GetUserSettingsReply`](common_web_api_user_UserCommands.GetUserSettingsReply.md)\>

#### Defined in

[src/common/web/api/user/UserCommands.ts:81](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/user/UserCommands.ts#L81)
