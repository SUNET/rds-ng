...
• **new ServerDisconnectedEvent**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ServerDisconnectedEvent`](common_web_api_network_NetworkEvents.ServerDisconnectedEvent.md)
...
[src/common/web/api/network/NetworkEvents.ts:77](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/network/NetworkEvents.ts#L77)
...
[src/common/web/api/network/NetworkEvents.ts:76](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/network/NetworkEvents.ts#L76)
...
[src/common/web/api/network/NetworkEvents.ts:82](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/network/NetworkEvents.ts#L82)
