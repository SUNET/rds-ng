---
id: "common_web_api_project_ProjectJobEvents.ProjectJobsListEvent"
title: "Class: ProjectJobsListEvent"
sidebar_label: "ProjectJobsListEvent"
custom_edit_url: null
---

[common/web/api/project/ProjectJobEvents](../modules/common_web_api_project_ProjectJobEvents.md).ProjectJobsListEvent
...
• **new ProjectJobsListEvent**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ProjectJobsListEvent`](common_web_api_project_ProjectJobEvents.ProjectJobsListEvent.md)
...
[src/common/web/api/project/ProjectJobEvents.ts:30](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectJobEvents.ts#L30)
...
▸ **build**(`messageBuilder`, `jobs`, `chain?`): [`EventComposer`](common_web_core_messaging_composers_EventComposer.EventComposer.md)<[`ProjectJobsListEvent`](common_web_api_project_ProjectJobEvents.ProjectJobsListEvent.md)\>
...
[`EventComposer`](common_web_core_messaging_composers_EventComposer.EventComposer.md)<[`ProjectJobsListEvent`](common_web_api_project_ProjectJobEvents.ProjectJobsListEvent.md)\>

#### Defined in

[src/common/web/api/project/ProjectJobEvents.ts:35](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectJobEvents.ts#L35)
