---
id: "common_web_api_project_ProjectJobCommands.InitiateProjectJobReply"
title: "Class: InitiateProjectJobReply"
sidebar_label: "InitiateProjectJobReply"
custom_edit_url: null
---

[common/web/api/project/ProjectJobCommands](../modules/common_web_api_project_ProjectJobCommands.md).InitiateProjectJobReply
...
• **new InitiateProjectJobReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`InitiateProjectJobReply`](common_web_api_project_ProjectJobCommands.InitiateProjectJobReply.md)
...
▸ **build**(`messageBuilder`, `cmd`, `success?`, `message?`): [`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`InitiateProjectJobReply`](common_web_api_project_ProjectJobCommands.InitiateProjectJobReply.md)\>
...
| `cmd` | [`InitiateProjectJobCommand`](common_web_api_project_ProjectJobCommands.InitiateProjectJobCommand.md) | `undefined` |
| `success` | `boolean` | `true` |
| `message` | `string` | `""` |

#### Returns

[`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`InitiateProjectJobReply`](common_web_api_project_ProjectJobCommands.InitiateProjectJobReply.md)\>

#### Defined in

[src/common/web/api/project/ProjectJobCommands.ts:94](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectJobCommands.ts#L94)
