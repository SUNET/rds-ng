---
id: "common_web_api_connector_ConnectorEvents.ConnectorAnnounceEvent"
title: "Class: ConnectorAnnounceEvent"
sidebar_label: "ConnectorAnnounceEvent"
custom_edit_url: null
---

[common/web/api/connector/ConnectorEvents](../modules/common_web_api_connector_ConnectorEvents.md).ConnectorAnnounceEvent
...
• **new ConnectorAnnounceEvent**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ConnectorAnnounceEvent`](common_web_api_connector_ConnectorEvents.ConnectorAnnounceEvent.md)
...
• `Readonly` **authorization\_private**: [`AuthorizationSettings`](../interfaces/common_web_data_entities_authorization_AuthorizationSettings.AuthorizationSettings.md)

#### Defined in

[src/common/web/api/connector/ConnectorEvents.ts:42](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/connector/ConnectorEvents.ts#L42)

___

### authorization\_public

• `Readonly` **authorization\_public**: [`AuthorizationSettings`](../interfaces/common_web_data_entities_authorization_AuthorizationSettings.AuthorizationSettings.md)

#### Defined in

[src/common/web/api/connector/ConnectorEvents.ts:41](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/connector/ConnectorEvents.ts#L41)
...
[src/common/web/api/connector/ConnectorEvents.ts:39](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/connector/ConnectorEvents.ts#L39)
...
[src/common/web/api/connector/ConnectorEvents.ts:35](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/connector/ConnectorEvents.ts#L35)
...
[src/common/web/api/connector/ConnectorEvents.ts:38](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/connector/ConnectorEvents.ts#L38)
...
[src/common/web/api/connector/ConnectorEvents.ts:37](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/connector/ConnectorEvents.ts#L37)
...
[src/common/web/api/connector/ConnectorEvents.ts:47](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/connector/ConnectorEvents.ts#L47)
...
[src/common/web/api/connector/ConnectorEvents.ts:51](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/connector/ConnectorEvents.ts#L51)
...
• `Readonly` **options**: [`ConnectorOptions`](../enums/common_web_data_entities_connector_Connector.ConnectorOptions.md) = `ConnectorOptions.Default`

#### Defined in

[src/common/web/api/connector/ConnectorEvents.ts:43](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/connector/ConnectorEvents.ts#L43)
...
▸ **build**(`messageBuilder`, `connectorID`, `name`, `description`, `category`, `authorizationPublic`, `authorizationPrivate`, `options`, `logos`, `metadataProfiles`, `chain?`): [`EventComposer`](common_web_core_messaging_composers_EventComposer.EventComposer.md)<[`ConnectorAnnounceEvent`](common_web_api_connector_ConnectorEvents.ConnectorAnnounceEvent.md)\>
...
| `authorizationPublic` | [`AuthorizationSettings`](../interfaces/common_web_data_entities_authorization_AuthorizationSettings.AuthorizationSettings.md) | `undefined` |
| `authorizationPrivate` | [`AuthorizationSettings`](../interfaces/common_web_data_entities_authorization_AuthorizationSettings.AuthorizationSettings.md) | `undefined` |
| `options` | [`ConnectorOptions`](../enums/common_web_data_entities_connector_Connector.ConnectorOptions.md) | `undefined` |
| `logos` | [`ConnectorLogos`](common_web_data_entities_connector_Connector.ConnectorLogos.md) | `undefined` |
| `metadataProfiles` | [`MetadataProfileContainerList`](../modules/common_web_data_entities_metadata_MetadataProfileContainer.md#metadataprofilecontainerlist) | `undefined` |
...
[src/common/web/api/connector/ConnectorEvents.ts:56](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/connector/ConnectorEvents.ts#L56)
