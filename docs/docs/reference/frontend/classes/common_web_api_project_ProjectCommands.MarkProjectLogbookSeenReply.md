---
id: "common_web_api_project_ProjectCommands.MarkProjectLogbookSeenReply"
title: "Class: MarkProjectLogbookSeenReply"
sidebar_label: "MarkProjectLogbookSeenReply"
custom_edit_url: null
---

[common/web/api/project/ProjectCommands](../modules/common_web_api_project_ProjectCommands.md).MarkProjectLogbookSeenReply
...
• **new MarkProjectLogbookSeenReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`MarkProjectLogbookSeenReply`](common_web_api_project_ProjectCommands.MarkProjectLogbookSeenReply.md)
...
▸ **build**(`messageBuilder`, `cmd`, `success?`, `message?`): [`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`MarkProjectLogbookSeenReply`](common_web_api_project_ProjectCommands.MarkProjectLogbookSeenReply.md)\>
...
| `cmd` | [`MarkProjectLogbookSeenCommand`](common_web_api_project_ProjectCommands.MarkProjectLogbookSeenCommand.md) | `undefined` |
| `success` | `boolean` | `true` |
| `message` | `string` | `""` |

#### Returns

[`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`MarkProjectLogbookSeenReply`](common_web_api_project_ProjectCommands.MarkProjectLogbookSeenReply.md)\>

#### Defined in

[src/common/web/api/project/ProjectCommands.ts:215](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectCommands.ts#L215)
