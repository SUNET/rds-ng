...
- [`Message`](common_web_core_messaging_Message.Message.md)
  ...
  ↳↳ [`RequestAuthorizationReply`](common_web_api_authorization_AuthorizationCommands.RequestAuthorizationReply.md)

  ↳↳ [`RevokeAuthorizationReply`](common_web_api_authorization_AuthorizationCommands.RevokeAuthorizationReply.md)
  ...
  ↳↳ [`MarkProjectLogbookSeenReply`](common_web_api_project_ProjectCommands.MarkProjectLogbookSeenReply.md)
  ...
  ↳↳ [`ListProjectJobsReply`](common_web_api_project_ProjectJobCommands.ListProjectJobsReply.md)

  ↳↳ [`InitiateProjectJobReply`](common_web_api_project_ProjectJobCommands.InitiateProjectJobReply.md)

  ↳↳ [`AssignResourcesBrokerReply`](common_web_api_resource_ResourceCommands.AssignResourcesBrokerReply.md)

  ↳↳ [`ListResourcesReply`](common_web_api_resource_ResourceCommands.ListResourcesReply.md)

  ↳↳ [`GetResourceReply`](common_web_api_resource_ResourceCommands.GetResourceReply.md)

  ↳↳ [`GetSessionValueReply`](common_web_api_session_SessionCommands.GetSessionValueReply.md)

  ↳↳ [`SetSessionValueReply`](common_web_api_session_SessionCommands.SetSessionValueReply.md)

  ↳↳ [`AuthenticateUserReply`](common_web_api_user_UserCommands.AuthenticateUserReply.md)

  ↳↳ [`GetUserSettingsReply`](common_web_api_user_UserCommands.GetUserSettingsReply.md)

  ↳↳ [`SetUserSettingsReply`](common_web_api_user_UserCommands.SetUserSettingsReply.md)

  ↳↳ [`ListUserAuthorizationsReply`](common_web_api_user_UserCommands.ListUserAuthorizationsReply.md)

## Constructors

### constructor

• **new CommandReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`CommandReply`](common_web_core_messaging_CommandReply.CommandReply.md)
