---
id: "common_web_api_user_UserEvents.UserAuthorizationsListEvent"
title: "Class: UserAuthorizationsListEvent"
sidebar_label: "UserAuthorizationsListEvent"
custom_edit_url: null
---

[common/web/api/user/UserEvents](../modules/common_web_api_user_UserEvents.md).UserAuthorizationsListEvent
...
• **new UserAuthorizationsListEvent**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`UserAuthorizationsListEvent`](common_web_api_user_UserEvents.UserAuthorizationsListEvent.md)
...
[src/common/web/api/user/UserEvents.ts:17](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/user/UserEvents.ts#L17)
...
▸ **build**(`messageBuilder`, `authorizations`, `chain?`): [`EventComposer`](common_web_core_messaging_composers_EventComposer.EventComposer.md)<[`UserAuthorizationsListEvent`](common_web_api_user_UserEvents.UserAuthorizationsListEvent.md)\>
...
[`EventComposer`](common_web_core_messaging_composers_EventComposer.EventComposer.md)<[`UserAuthorizationsListEvent`](common_web_api_user_UserEvents.UserAuthorizationsListEvent.md)\>

#### Defined in

[src/common/web/api/user/UserEvents.ts:22](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/user/UserEvents.ts#L22)
