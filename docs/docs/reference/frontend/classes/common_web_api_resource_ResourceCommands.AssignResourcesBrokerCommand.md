---
id: "common_web_api_resource_ResourceCommands.AssignResourcesBrokerCommand"
title: "Class: AssignResourcesBrokerCommand"
sidebar_label: "AssignResourcesBrokerCommand"
custom_edit_url: null
---

[common/web/api/resource/ResourceCommands](../modules/common_web_api_resource_ResourceCommands.md).AssignResourcesBrokerCommand
...
• **new AssignResourcesBrokerCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`AssignResourcesBrokerCommand`](common_web_api_resource_ResourceCommands.AssignResourcesBrokerCommand.md)
...
[src/common/web/api/resource/ResourceCommands.ts:20](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/resource/ResourceCommands.ts#L20)
...
[src/common/web/api/resource/ResourceCommands.ts:21](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/resource/ResourceCommands.ts#L21)
...
▸ **build**(`messageBuilder`, `broker`, `config`, `chain?`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`AssignResourcesBrokerCommand`](common_web_api_resource_ResourceCommands.AssignResourcesBrokerCommand.md)\>
...
[`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`AssignResourcesBrokerCommand`](common_web_api_resource_ResourceCommands.AssignResourcesBrokerCommand.md)\>

#### Defined in

[src/common/web/api/resource/ResourceCommands.ts:26](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/resource/ResourceCommands.ts#L26)
