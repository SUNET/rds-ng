---
id: "common_web_api_user_UserCommands.ListUserAuthorizationsReply"
title: "Class: ListUserAuthorizationsReply"
sidebar_label: "ListUserAuthorizationsReply"
custom_edit_url: null
---

[common/web/api/user/UserCommands](../modules/common_web_api_user_UserCommands.md).ListUserAuthorizationsReply

Reply to ``ListUserAuthorizationsCommand``.

**`Param`**

List of all granted authorizations.
...
• **new ListUserAuthorizationsReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ListUserAuthorizationsReply`](common_web_api_user_UserCommands.ListUserAuthorizationsReply.md)
...
[src/common/web/api/user/UserCommands.ts:158](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/user/UserCommands.ts#L158)
...
▸ **build**(`messageBuilder`, `cmd`, `authorizations`, `success?`, `message?`): [`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`ListUserAuthorizationsReply`](common_web_api_user_UserCommands.ListUserAuthorizationsReply.md)\>
...
| `cmd` | [`ListUserAuthorizationsCommand`](common_web_api_user_UserCommands.ListUserAuthorizationsCommand.md) | `undefined` |
...
[`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`ListUserAuthorizationsReply`](common_web_api_user_UserCommands.ListUserAuthorizationsReply.md)\>

#### Defined in

[src/common/web/api/user/UserCommands.ts:163](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/user/UserCommands.ts#L163)
