---
id: "common_web_api_user_UserCommands.SetUserSettingsCommand"
title: "Class: SetUserSettingsCommand"
sidebar_label: "SetUserSettingsCommand"
custom_edit_url: null
---

[common/web/api/user/UserCommands](../modules/common_web_api_user_UserCommands.md).SetUserSettingsCommand
...
• **new SetUserSettingsCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`SetUserSettingsCommand`](common_web_api_user_UserCommands.SetUserSettingsCommand.md)
...
[src/common/web/api/user/UserCommands.ts:101](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/user/UserCommands.ts#L101)
...
▸ **build**(`messageBuilder`, `settings`, `chain?`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`SetUserSettingsCommand`](common_web_api_user_UserCommands.SetUserSettingsCommand.md)\>
...
[src/common/web/api/user/UserCommands.ts:106](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/user/UserCommands.ts#L106)
