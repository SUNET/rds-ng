---
id: "common_web_api_authorization_AuthorizationCommands.RevokeAuthorizationCommand"
title: "Class: RevokeAuthorizationCommand"
sidebar_label: "RevokeAuthorizationCommand"
custom_edit_url: null
---

[common/web/api/authorization/AuthorizationCommands](../modules/common_web_api_authorization_AuthorizationCommands.md).RevokeAuthorizationCommand
...
• **new RevokeAuthorizationCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`RevokeAuthorizationCommand`](common_web_api_authorization_AuthorizationCommands.RevokeAuthorizationCommand.md)
...
[src/common/web/api/authorization/AuthorizationCommands.ts:80](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/authorization/AuthorizationCommands.ts#L80)
...
[src/common/web/api/authorization/AuthorizationCommands.ts:82](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/authorization/AuthorizationCommands.ts#L82)
...
[src/common/web/api/authorization/AuthorizationCommands.ts:79](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/authorization/AuthorizationCommands.ts#L79)
...
▸ **build**(`messageBuilder`, `userID`, `authID`, `force?`, `chain?`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`RevokeAuthorizationCommand`](common_web_api_authorization_AuthorizationCommands.RevokeAuthorizationCommand.md)\>
...
[src/common/web/api/authorization/AuthorizationCommands.ts:87](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/authorization/AuthorizationCommands.ts#L87)
