...
• **new ListConnectorsReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ListConnectorsReply`](common_web_api_connector_ConnectorCommands.ListConnectorsReply.md)
...
• `Readonly` **connectors**: [`Connector`](common_web_data_entities_connector_Connector.Connector.md)[] = `[]`

#### Defined in

[src/common/web/api/connector/ConnectorCommands.ts:33](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/connector/ConnectorCommands.ts#L33)
...
| `connectors` | [`Connector`](common_web_data_entities_connector_Connector.Connector.md)[] | `undefined` |
...
[src/common/web/api/connector/ConnectorCommands.ts:38](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/connector/ConnectorCommands.ts#L38)
