---
id: "common_web_api_session_SessionCommands.GetSessionValueReply"
title: "Class: GetSessionValueReply"
sidebar_label: "GetSessionValueReply"
custom_edit_url: null
---

[common/web/api/session/SessionCommands](../modules/common_web_api_session_SessionCommands.md).GetSessionValueReply

Reply to ``GetSessionValueCommand``.

**`Param`**

The value or *undefined* if no such value was found.
...
• **new GetSessionValueReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`GetSessionValueReply`](common_web_api_session_SessionCommands.GetSessionValueReply.md)
...
[src/common/web/api/session/SessionCommands.ts:31](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/session/SessionCommands.ts#L31)
...
▸ **build**(`messageBuilder`, `cmd`, `value`, `success?`, `message?`): [`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`GetSessionValueReply`](common_web_api_session_SessionCommands.GetSessionValueReply.md)\>
...
| `cmd` | [`GetSessionValueCommand`](common_web_api_session_SessionCommands.GetSessionValueCommand.md) | `undefined` |
| `value` | `any` | `undefined` |
...
[`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`GetSessionValueReply`](common_web_api_session_SessionCommands.GetSessionValueReply.md)\>

#### Defined in

[src/common/web/api/session/SessionCommands.ts:36](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/session/SessionCommands.ts#L36)
