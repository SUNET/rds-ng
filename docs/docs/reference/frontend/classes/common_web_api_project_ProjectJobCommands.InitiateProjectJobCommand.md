---
id: "common_web_api_project_ProjectJobCommands.InitiateProjectJobCommand"
title: "Class: InitiateProjectJobCommand"
sidebar_label: "InitiateProjectJobCommand"
custom_edit_url: null
---

[common/web/api/project/ProjectJobCommands](../modules/common_web_api_project_ProjectJobCommands.md).InitiateProjectJobCommand
...
List of enabled exporters for automatic file generation.
...
• **new InitiateProjectJobCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`InitiateProjectJobCommand`](common_web_api_project_ProjectJobCommands.InitiateProjectJobCommand.md)
...
• `Readonly` **auto\_exports**: `string`[] = `[]`

#### Defined in

[src/common/web/api/project/ProjectJobCommands.ts:66](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectJobCommands.ts#L66)
...
[src/common/web/api/project/ProjectJobCommands.ts:62](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectJobCommands.ts#L62)
...
[src/common/web/api/project/ProjectJobCommands.ts:61](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectJobCommands.ts#L61)
...
▸ **build**(`messageBuilder`, `projectID`, `connectorInstance`, `autoExports?`, `chain?`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`InitiateProjectJobCommand`](common_web_api_project_ProjectJobCommands.InitiateProjectJobCommand.md)\>
...
[src/common/web/api/project/ProjectJobCommands.ts:71](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectJobCommands.ts#L71)
