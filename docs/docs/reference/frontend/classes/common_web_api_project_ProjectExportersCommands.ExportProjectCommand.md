---
id: "common_web_api_project_ProjectExportersCommands.ExportProjectCommand"
title: "Class: ExportProjectCommand"
sidebar_label: "ExportProjectCommand"
custom_edit_url: null
---

[common/web/api/project/ProjectExportersCommands](../modules/common_web_api_project_ProjectExportersCommands.md).ExportProjectCommand
...
• **new ExportProjectCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ExportProjectCommand`](common_web_api_project_ProjectExportersCommands.ExportProjectCommand.md)
...
[src/common/web/api/project/ProjectExportersCommands.ts:58](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectExportersCommands.ts#L58)
...
[src/common/web/api/project/ProjectExportersCommands.ts:56](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectExportersCommands.ts#L56)
...
[src/common/web/api/project/ProjectExportersCommands.ts:59](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectExportersCommands.ts#L59)
...
▸ **build**(`messageBuilder`, `projectID`, `exporter`, `scope`, `chain?`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`ExportProjectCommand`](common_web_api_project_ProjectExportersCommands.ExportProjectCommand.md)\>
...
[`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`ExportProjectCommand`](common_web_api_project_ProjectExportersCommands.ExportProjectCommand.md)\>

#### Defined in

[src/common/web/api/project/ProjectExportersCommands.ts:64](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectExportersCommands.ts#L64)
