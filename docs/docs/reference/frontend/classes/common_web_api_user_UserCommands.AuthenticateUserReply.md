---
id: "common_web_api_user_UserCommands.AuthenticateUserReply"
title: "Class: AuthenticateUserReply"
sidebar_label: "AuthenticateUserReply"
custom_edit_url: null
---

[common/web/api/user/UserCommands](../modules/common_web_api_user_UserCommands.md).AuthenticateUserReply

Reply to ``AuthenticateUserCommand``.

**`Param`**

The authorization state of the user in his host system.
...
• **new AuthenticateUserReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`AuthenticateUserReply`](common_web_api_user_UserCommands.AuthenticateUserReply.md)
...
[`AuthenticateUserReply`](common_web_api_user_UserCommands.AuthenticateUserReply.md)
...
• `Readonly` **authorization\_state**: [`AuthorizationState`](../enums/common_web_data_entities_authorization_AuthorizationState.AuthorizationState.md) = `AuthorizationState.NotAuthorized`

#### Defined in

[src/common/web/api/user/UserCommands.ts:35](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/user/UserCommands.ts#L35)
...
[src/common/web/api/user/UserCommands.ts:37](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/user/UserCommands.ts#L37)
...
▸ **build**(`messageBuilder`, `cmd`, `authState`, `fingerprint?`, `success?`, `message?`): [`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`AuthenticateUserReply`](common_web_api_user_UserCommands.AuthenticateUserReply.md)\>
...
| `cmd` | [`AuthenticateUserCommand`](common_web_api_user_UserCommands.AuthenticateUserCommand.md) | `undefined` |
...
[`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`AuthenticateUserReply`](common_web_api_user_UserCommands.AuthenticateUserReply.md)\>

#### Defined in

[src/common/web/api/user/UserCommands.ts:42](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/user/UserCommands.ts#L42)
