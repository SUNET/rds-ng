...
• **new CreateProjectCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`CreateProjectCommand`](common_web_api_project_ProjectCommands.CreateProjectCommand.md)
...
[src/common/web/api/project/ProjectCommands.ts:65](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectCommands.ts#L65)
...
[src/common/web/api/project/ProjectCommands.ts:69](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectCommands.ts#L69)
...
[src/common/web/api/project/ProjectCommands.ts:62](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectCommands.ts#L62)
...
[src/common/web/api/project/ProjectCommands.ts:64](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectCommands.ts#L64)
...
▸ **build**(`messageBuilder`, `resourcesPath`, `title`, `description`, `options`, `chain?`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`CreateProjectCommand`](common_web_api_project_ProjectCommands.CreateProjectCommand.md)\>
...
[src/common/web/api/project/ProjectCommands.ts:74](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectCommands.ts#L74)
