...
• **new DeleteProjectCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`DeleteProjectCommand`](common_web_api_project_ProjectCommands.DeleteProjectCommand.md)
...
[src/common/web/api/project/ProjectCommands.ts:232](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectCommands.ts#L232)
...
[src/common/web/api/project/ProjectCommands.ts:237](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectCommands.ts#L237)
