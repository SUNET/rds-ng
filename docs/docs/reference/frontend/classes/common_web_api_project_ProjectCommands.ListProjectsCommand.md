...
• **new ListProjectsCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ListProjectsCommand`](common_web_api_project_ProjectCommands.ListProjectsCommand.md)
...
[src/common/web/api/project/ProjectCommands.ts:22](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectCommands.ts#L22)
