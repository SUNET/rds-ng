---
id: "common_web_api_project_ProjectJobCommands.ListProjectJobsReply"
title: "Class: ListProjectJobsReply"
sidebar_label: "ListProjectJobsReply"
custom_edit_url: null
---

[common/web/api/project/ProjectJobCommands](../modules/common_web_api_project_ProjectJobCommands.md).ListProjectJobsReply

Reply to ``ListProjectJobsCommand``.

**`Param`**

The project jobs list.
...
• **new ListProjectJobsReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ListProjectJobsReply`](common_web_api_project_ProjectJobCommands.ListProjectJobsReply.md)
...
• `Readonly` **jobs**: [`ProjectJob`](common_web_data_entities_project_ProjectJob.ProjectJob.md)[] = `[]`

#### Defined in

[src/common/web/api/project/ProjectJobCommands.ts:36](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectJobCommands.ts#L36)
...
▸ **build**(`messageBuilder`, `cmd`, `jobs`, `success?`, `message?`): [`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`ListProjectJobsReply`](common_web_api_project_ProjectJobCommands.ListProjectJobsReply.md)\>
...
| `cmd` | [`ListProjectJobsCommand`](common_web_api_project_ProjectJobCommands.ListProjectJobsCommand.md) | `undefined` |
| `jobs` | [`ProjectJob`](common_web_data_entities_project_ProjectJob.ProjectJob.md)[] | `undefined` |
| `success` | `boolean` | `true` |
| `message` | `string` | `""` |

#### Returns

[`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`ListProjectJobsReply`](common_web_api_project_ProjectJobCommands.ListProjectJobsReply.md)\>

#### Defined in

[src/common/web/api/project/ProjectJobCommands.ts:41](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectJobCommands.ts#L41)
