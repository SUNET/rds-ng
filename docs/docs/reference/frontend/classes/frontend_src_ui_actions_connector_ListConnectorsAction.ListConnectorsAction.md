---
id: "frontend_src_ui_actions_connector_ListConnectorsAction.ListConnectorsAction"
title: "Class: ListConnectorsAction"
sidebar_label: "ListConnectorsAction"
custom_edit_url: null
---

[frontend/src/ui/actions/connector/ListConnectorsAction](../modules/frontend_src_ui_actions_connector_ListConnectorsAction.md).ListConnectorsAction
...
• **new ListConnectorsAction**(`comp`, `suppressDefaultNotifiers?`): [`ListConnectorsAction`](frontend_src_ui_actions_connector_ListConnectorsAction.ListConnectorsAction.md)
...
[src/frontend/src/ui/actions/connector/ListConnectorsAction.ts:21](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/connector/ListConnectorsAction.ts#L21)
...
▸ **completed**(`cb`): [`ListConnectorsAction`](frontend_src_ui_actions_connector_ListConnectorsAction.ListConnectorsAction.md)
...
▸ **failed**(`cb`): [`ListConnectorsAction`](frontend_src_ui_actions_connector_ListConnectorsAction.ListConnectorsAction.md)
...
[src/frontend/src/ui/actions/connector/ListConnectorsAction.ts:14](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/connector/ListConnectorsAction.ts#L14)
