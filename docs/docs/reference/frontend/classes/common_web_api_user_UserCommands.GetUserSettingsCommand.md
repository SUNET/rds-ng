---
id: "common_web_api_user_UserCommands.GetUserSettingsCommand"
title: "Class: GetUserSettingsCommand"
sidebar_label: "GetUserSettingsCommand"
custom_edit_url: null
---

[common/web/api/user/UserCommands](../modules/common_web_api_user_UserCommands.md).GetUserSettingsCommand
...
• **new GetUserSettingsCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`GetUserSettingsCommand`](common_web_api_user_UserCommands.GetUserSettingsCommand.md)
...
▸ **build**(`messageBuilder`, `chain?`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`GetUserSettingsCommand`](common_web_api_user_UserCommands.GetUserSettingsCommand.md)\>
...
[src/common/web/api/user/UserCommands.ts:62](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/user/UserCommands.ts#L62)
