---
id: "common_web_api_user_UserCommands.AuthenticateUserCommand"
title: "Class: AuthenticateUserCommand"
sidebar_label: "AuthenticateUserCommand"
custom_edit_url: null
---

[common/web/api/user/UserCommands](../modules/common_web_api_user_UserCommands.md).AuthenticateUserCommand
...
• **new AuthenticateUserCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`AuthenticateUserCommand`](common_web_api_user_UserCommands.AuthenticateUserCommand.md)
...
• `Readonly` **user\_token**: [`UserToken`](../interfaces/common_web_data_entities_user_UserToken.UserToken.md)

#### Defined in

[src/common/web/api/user/UserCommands.ts:18](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/user/UserCommands.ts#L18)
...
▸ **build**(`messageBuilder`, `userToken`, `chain?`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`AuthenticateUserCommand`](common_web_api_user_UserCommands.AuthenticateUserCommand.md)\>
...
| `userToken` | [`UserToken`](../interfaces/common_web_data_entities_user_UserToken.UserToken.md) | `undefined` |
| `chain` | ``null`` \| [`Message`](common_web_core_messaging_Message.Message.md) | `null` |

#### Returns

[`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`AuthenticateUserCommand`](common_web_api_user_UserCommands.AuthenticateUserCommand.md)\>

#### Defined in

[src/common/web/api/user/UserCommands.ts:23](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/user/UserCommands.ts#L23)
