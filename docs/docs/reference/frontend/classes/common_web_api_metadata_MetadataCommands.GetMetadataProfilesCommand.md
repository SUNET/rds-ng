---
id: "common_web_api_metadata_MetadataCommands.GetMetadataProfilesCommand"
title: "Class: GetMetadataProfilesCommand"
sidebar_label: "GetMetadataProfilesCommand"
custom_edit_url: null
---

[common/web/api/metadata/MetadataCommands](../modules/common_web_api_metadata_MetadataCommands.md).GetMetadataProfilesCommand
...
- [`Command`](common_web_core_messaging_Command.Command.md)
  ...
  ↳ **`GetMetadataProfilesCommand`**

## Constructors

### constructor

• **new GetMetadataProfilesCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`GetMetadataProfilesCommand`](common_web_api_metadata_MetadataCommands.GetMetadataProfilesCommand.md)
...
▸ **build**(`messageBuilder`, `chain?`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`GetMetadataProfilesCommand`](common_web_api_metadata_MetadataCommands.GetMetadataProfilesCommand.md)\>
...
[src/common/web/api/metadata/MetadataCommands.ts:19](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/metadata/MetadataCommands.ts#L19)
