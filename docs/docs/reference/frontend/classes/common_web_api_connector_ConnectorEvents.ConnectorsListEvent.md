...
• **new ConnectorsListEvent**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ConnectorsListEvent`](common_web_api_connector_ConnectorEvents.ConnectorsListEvent.md)
...
[src/common/web/api/connector/ConnectorEvents.ts:20](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/connector/ConnectorEvents.ts#L20)
...
[src/common/web/api/connector/ConnectorEvents.ts:25](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/connector/ConnectorEvents.ts#L25)
