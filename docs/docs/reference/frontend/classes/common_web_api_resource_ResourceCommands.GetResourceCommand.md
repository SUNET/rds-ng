---
id: "common_web_api_resource_ResourceCommands.GetResourceCommand"
title: "Class: GetResourceCommand"
sidebar_label: "GetResourceCommand"
custom_edit_url: null
---

[common/web/api/resource/ResourceCommands](../modules/common_web_api_resource_ResourceCommands.md).GetResourceCommand
...
• **new GetResourceCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`GetResourceCommand`](common_web_api_resource_ResourceCommands.GetResourceCommand.md)
...
[src/common/web/api/resource/ResourceCommands.ts:124](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/resource/ResourceCommands.ts#L124)
...
▸ **build**(`messageBuilder`, `resource`, `chain?`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`GetResourceCommand`](common_web_api_resource_ResourceCommands.GetResourceCommand.md)\>
...
[src/common/web/api/resource/ResourceCommands.ts:129](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/resource/ResourceCommands.ts#L129)
