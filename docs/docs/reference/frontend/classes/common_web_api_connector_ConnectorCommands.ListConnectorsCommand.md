...
• **new ListConnectorsCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ListConnectorsCommand`](common_web_api_connector_ConnectorCommands.ListConnectorsCommand.md)
...
[src/common/web/api/connector/ConnectorCommands.ts:19](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/connector/ConnectorCommands.ts#L19)
