---
id: "frontend_src_ui_actions_project_ListProjectgExportersAction.ListProjectgExportersAction"
title: "Class: ListProjectgExportersAction"
sidebar_label: "ListProjectgExportersAction"
custom_edit_url: null
---

[frontend/src/ui/actions/project/ListProjectgExportersAction](../modules/frontend_src_ui_actions_project_ListProjectgExportersAction.md).ListProjectgExportersAction

Action to retrieve all projects.

## Hierarchy

- [`FrontendCommandAction`](frontend_src_ui_actions_FrontendCommandAction.FrontendCommandAction.md)<[`ListProjectExportersCommand`](common_web_api_project_ProjectExportersCommands.ListProjectExportersCommand.md), [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`ListProjectExportersCommand`](common_web_api_project_ProjectExportersCommands.ListProjectExportersCommand.md)\>\>

  ↳ **`ListProjectgExportersAction`**

## Constructors

### constructor

• **new ListProjectgExportersAction**(`comp`, `suppressDefaultNotifiers?`): [`ListProjectgExportersAction`](frontend_src_ui_actions_project_ListProjectgExportersAction.ListProjectgExportersAction.md)
...
• `Protected` **\_composer**: ``null`` \| [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`ListProjectExportersCommand`](common_web_api_project_ProjectExportersCommands.ListProjectExportersCommand.md)\> = `null`
...
[src/frontend/src/ui/actions/project/ListProjectgExportersAction.ts:21](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/project/ListProjectgExportersAction.ts#L21)
...
▸ **completed**(`cb`): [`ListProjectgExportersAction`](frontend_src_ui_actions_project_ListProjectgExportersAction.ListProjectgExportersAction.md)
...
▸ **failed**(`cb`): [`ListProjectgExportersAction`](frontend_src_ui_actions_project_ListProjectgExportersAction.ListProjectgExportersAction.md)
...
▸ **prepare**(): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`ListProjectExportersCommand`](common_web_api_project_ProjectExportersCommands.ListProjectExportersCommand.md)\>

Prepares this action.

#### Returns

[`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`ListProjectExportersCommand`](common_web_api_project_ProjectExportersCommands.ListProjectExportersCommand.md)\>
...
[src/frontend/src/ui/actions/project/ListProjectgExportersAction.ts:14](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/project/ListProjectgExportersAction.ts#L14)
