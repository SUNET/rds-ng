---
id: "frontend_src_ui_actions_project_InitiateProjectJobAction.InitiateProjectJobAction"
title: "Class: InitiateProjectJobAction"
sidebar_label: "InitiateProjectJobAction"
custom_edit_url: null
---

[frontend/src/ui/actions/project/InitiateProjectJobAction](../modules/frontend_src_ui_actions_project_InitiateProjectJobAction.md).InitiateProjectJobAction

Action to initiate a project job.

## Hierarchy

- [`FrontendCommandAction`](frontend_src_ui_actions_FrontendCommandAction.FrontendCommandAction.md)<[`InitiateProjectJobCommand`](common_web_api_project_ProjectJobCommands.InitiateProjectJobCommand.md), [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`InitiateProjectJobCommand`](common_web_api_project_ProjectJobCommands.InitiateProjectJobCommand.md)\>\>

  ↳ **`InitiateProjectJobAction`**

## Constructors

### constructor

• **new InitiateProjectJobAction**(`comp`, `suppressDefaultNotifiers?`): [`InitiateProjectJobAction`](frontend_src_ui_actions_project_InitiateProjectJobAction.InitiateProjectJobAction.md)
...
• `Protected` **\_composer**: ``null`` \| [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`InitiateProjectJobCommand`](common_web_api_project_ProjectJobCommands.InitiateProjectJobCommand.md)\> = `null`
...
▸ **addDefaultNotifiers**(`project`, `connector`, `connectorInstance`): `void`
...
| `connector` | [`Connector`](common_web_data_entities_connector_Connector.Connector.md) |
| `connectorInstance` | [`ConnectorInstance`](common_web_data_entities_connector_ConnectorInstance.ConnectorInstance.md) |
...
[src/frontend/src/ui/actions/project/InitiateProjectJobAction.ts:28](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/project/InitiateProjectJobAction.ts#L28)
...
▸ **completed**(`cb`): [`InitiateProjectJobAction`](frontend_src_ui_actions_project_InitiateProjectJobAction.InitiateProjectJobAction.md)
...
▸ **failed**(`cb`): [`InitiateProjectJobAction`](frontend_src_ui_actions_project_InitiateProjectJobAction.InitiateProjectJobAction.md)
...
[src/frontend/src/ui/actions/project/InitiateProjectJobAction.ts:58](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/project/InitiateProjectJobAction.ts#L58)
...
▸ **prepare**(`project`, `connector`, `connectorInstance`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`InitiateProjectJobCommand`](common_web_api_project_ProjectJobCommands.InitiateProjectJobCommand.md)\>
...
[`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`InitiateProjectJobCommand`](common_web_api_project_ProjectJobCommands.InitiateProjectJobCommand.md)\>
...
[src/frontend/src/ui/actions/project/InitiateProjectJobAction.ts:21](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/project/InitiateProjectJobAction.ts#L21)
