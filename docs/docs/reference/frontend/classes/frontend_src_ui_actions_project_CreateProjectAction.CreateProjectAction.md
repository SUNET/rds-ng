---
id: "frontend_src_ui_actions_project_CreateProjectAction.CreateProjectAction"
title: "Class: CreateProjectAction"
sidebar_label: "CreateProjectAction"
custom_edit_url: null
---

[frontend/src/ui/actions/project/CreateProjectAction](../modules/frontend_src_ui_actions_project_CreateProjectAction.md).CreateProjectAction
...
• **new CreateProjectAction**(`comp`, `suppressDefaultNotifiers?`): [`CreateProjectAction`](frontend_src_ui_actions_project_CreateProjectAction.CreateProjectAction.md)
...
[src/frontend/src/ui/actions/project/CreateProjectAction.ts:32](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/project/CreateProjectAction.ts#L32)
...
▸ **completed**(`cb`): [`CreateProjectAction`](frontend_src_ui_actions_project_CreateProjectAction.CreateProjectAction.md)
...
▸ **failed**(`cb`): [`CreateProjectAction`](frontend_src_ui_actions_project_CreateProjectAction.CreateProjectAction.md)
...
▸ **prepare**(`resourcesPath`, `title`, `description`, `options`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`CreateProjectCommand`](common_web_api_project_ProjectCommands.CreateProjectCommand.md)\>
...
[src/frontend/src/ui/actions/project/CreateProjectAction.ts:25](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/project/CreateProjectAction.ts#L25)
...
▸ **showEditDialog**(): [`ExtendedDialogResult`](../modules/common_web_ui_dialogs_ExtendedDialog.md#extendeddialogresult)<[`EditProjectDialogData`](../interfaces/frontend_src_ui_dialogs_project_edit_EditProjectDialog.EditProjectDialogData.md)\>
...
[src/frontend/src/ui/actions/project/CreateProjectAction.ts:21](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/frontend/src/ui/actions/project/CreateProjectAction.ts#L21)
