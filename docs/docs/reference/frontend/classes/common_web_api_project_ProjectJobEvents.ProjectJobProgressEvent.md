---
id: "common_web_api_project_ProjectJobEvents.ProjectJobProgressEvent"
title: "Class: ProjectJobProgressEvent"
sidebar_label: "ProjectJobProgressEvent"
custom_edit_url: null
---

[common/web/api/project/ProjectJobEvents](../modules/common_web_api_project_ProjectJobEvents.md).ProjectJobProgressEvent
...
• **new ProjectJobProgressEvent**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ProjectJobProgressEvent`](common_web_api_project_ProjectJobEvents.ProjectJobProgressEvent.md)
...
[src/common/web/api/project/ProjectJobEvents.ts:51](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectJobEvents.ts#L51)

___

### contents

• `Readonly` **contents**: [`ProjectJobProgressContents`](../enums/common_web_api_project_ProjectJobEvents.ProjectJobProgressContents.md) = `ProjectJobProgressContents.None`

#### Defined in

[src/common/web/api/project/ProjectJobEvents.ts:53](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectJobEvents.ts#L53)
...
[src/common/web/api/project/ProjectJobEvents.ts:56](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectJobEvents.ts#L56)
...
[src/common/web/api/project/ProjectJobEvents.ts:55](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectJobEvents.ts#L55)
...
[src/common/web/api/project/ProjectJobEvents.ts:50](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectJobEvents.ts#L50)
...
▸ **build**(`messageBuilder`, `projectID`, `connectorInstance`, `contents`, `progress`, `message`, `chain?`): [`EventComposer`](common_web_core_messaging_composers_EventComposer.EventComposer.md)<[`ProjectJobProgressEvent`](common_web_api_project_ProjectJobEvents.ProjectJobProgressEvent.md)\>
...
| `contents` | [`ProjectJobProgressContents`](../enums/common_web_api_project_ProjectJobEvents.ProjectJobProgressContents.md) | `undefined` |
...
[`EventComposer`](common_web_core_messaging_composers_EventComposer.EventComposer.md)<[`ProjectJobProgressEvent`](common_web_api_project_ProjectJobEvents.ProjectJobProgressEvent.md)\>

#### Defined in

[src/common/web/api/project/ProjectJobEvents.ts:61](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectJobEvents.ts#L61)
