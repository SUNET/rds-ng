...
• **new CreateProjectReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`CreateProjectReply`](common_web_api_project_ProjectCommands.CreateProjectReply.md)
...
[src/common/web/api/project/ProjectCommands.ts:97](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectCommands.ts#L97)
...
[src/common/web/api/project/ProjectCommands.ts:102](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectCommands.ts#L102)
