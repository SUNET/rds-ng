---
id: "common_web_api_user_UserCommands.ListUserAuthorizationsCommand"
title: "Class: ListUserAuthorizationsCommand"
sidebar_label: "ListUserAuthorizationsCommand"
custom_edit_url: null
---

[common/web/api/user/UserCommands](../modules/common_web_api_user_UserCommands.md).ListUserAuthorizationsCommand
...
• **new ListUserAuthorizationsCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ListUserAuthorizationsCommand`](common_web_api_user_UserCommands.ListUserAuthorizationsCommand.md)
...
▸ **build**(`messageBuilder`, `chain?`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`ListUserAuthorizationsCommand`](common_web_api_user_UserCommands.ListUserAuthorizationsCommand.md)\>
...
[`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`ListUserAuthorizationsCommand`](common_web_api_user_UserCommands.ListUserAuthorizationsCommand.md)\>

#### Defined in

[src/common/web/api/user/UserCommands.ts:144](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/user/UserCommands.ts#L144)
