---
id: "common_web_api_project_ProjectEvents.ProjectTouchEvent"
title: "Class: ProjectTouchEvent"
sidebar_label: "ProjectTouchEvent"
custom_edit_url: null
---

[common/web/api/project/ProjectEvents](../modules/common_web_api_project_ProjectEvents.md).ProjectTouchEvent
...
• **new ProjectTouchEvent**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`, `apiKey?`): [`ProjectTouchEvent`](common_web_api_project_ProjectEvents.ProjectTouchEvent.md)
...
[src/common/web/api/project/ProjectEvents.ts:39](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectEvents.ts#L39)
...
▸ **build**(`messageBuilder`, `projectID`, `chain?`): [`EventComposer`](common_web_core_messaging_composers_EventComposer.EventComposer.md)<[`ProjectTouchEvent`](common_web_api_project_ProjectEvents.ProjectTouchEvent.md)\>
...
[src/common/web/api/project/ProjectEvents.ts:44](https://github.com/Sciebo-RDS/rds-ng/blob/cd602ee64/src/common/web/api/project/ProjectEvents.ts#L44)
