# Class: ConnectorCategoriesCatalog

Defined in: [src/frontend/src/data/entities/connector/categories/ConnectorCategoriesCatalog.ts:9](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/frontend/src/data/entities/connector/categories/ConnectorCategoriesCatalog.ts#L9)

Global catalog of all supported authentication schemes.

## Extends

- [`ItemsCatalog`](../../../../../../../../common/web/utils/ItemsCatalog/classes/ItemsCatalog.md)\<[`ConnectorCategory`](../../ConnectorCategory/classes/ConnectorCategory.md)\>

## Constructors

### Constructor

> **new ConnectorCategoriesCatalog**(): `ConnectorCategoriesCatalog`
