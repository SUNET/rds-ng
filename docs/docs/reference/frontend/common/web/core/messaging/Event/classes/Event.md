...
Defined in: [src/common/web/core/messaging/Event.ts:8](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/core/messaging/Event.ts#L8)
...
- [`ComponentInformationEvent`](../../../../api/component/ComponentEvents/classes/ComponentInformationEvent.md)
- [`ConnectorsListEvent`](../../../../api/connector/ConnectorEvents/classes/ConnectorsListEvent.md)
- [`ConnectorAnnounceEvent`](../../../../api/connector/ConnectorEvents/classes/ConnectorAnnounceEvent.md)
- [`ClientConnectedEvent`](../../../../api/network/NetworkEvents/classes/ClientConnectedEvent.md)
- [`ClientDisconnectedEvent`](../../../../api/network/NetworkEvents/classes/ClientDisconnectedEvent.md)
- [`ClientConnectionErrorEvent`](../../../../api/network/NetworkEvents/classes/ClientConnectionErrorEvent.md)
- [`ServerDisconnectedEvent`](../../../../api/network/NetworkEvents/classes/ServerDisconnectedEvent.md)
- [`ProjectsListEvent`](../../../../api/project/ProjectEvents/classes/ProjectsListEvent.md)
- [`ProjectTouchEvent`](../../../../api/project/ProjectEvents/classes/ProjectTouchEvent.md)
- [`ProjectLogbookEvent`](../../../../api/project/ProjectEvents/classes/ProjectLogbookEvent.md)
- [`ProjectExternalStateEvent`](../../../../api/project/ProjectEvents/classes/ProjectExternalStateEvent.md)
- [`ProjectJobsListEvent`](../../../../api/project/ProjectJobEvents/classes/ProjectJobsListEvent.md)
- [`ProjectJobProgressEvent`](../../../../api/project/ProjectJobEvents/classes/ProjectJobProgressEvent.md)
- [`ProjectJobCompletionEvent`](../../../../api/project/ProjectJobEvents/classes/ProjectJobCompletionEvent.md)
- [`UserAuthorizationsListEvent`](../../../../api/user/UserEvents/classes/UserAuthorizationsListEvent.md)

## Constructors

### Constructor

> **new Event**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `Event`
