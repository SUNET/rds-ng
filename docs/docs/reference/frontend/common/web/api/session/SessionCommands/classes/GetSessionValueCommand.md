# Class: GetSessionValueCommand

Defined in: [src/common/web/api/session/SessionCommands.ts:14](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/session/SessionCommands.ts#L14)
...
> **new GetSessionValueCommand**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `GetSessionValueCommand`
...
Defined in: [src/common/web/api/session/SessionCommands.ts:15](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/session/SessionCommands.ts#L15)
...
> `static` **build**(`messageBuilder`, `key`, `chain`): [`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`GetSessionValueCommand`\>

Defined in: [src/common/web/api/session/SessionCommands.ts:20](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/session/SessionCommands.ts#L20)
...
[`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`GetSessionValueCommand`\>
