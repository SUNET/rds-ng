# Class: SetSessionValueReply

Defined in: [src/common/web/api/session/SessionCommands.ts:72](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/session/SessionCommands.ts#L72)
...
> **new SetSessionValueReply**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `SetSessionValueReply`
...
> `static` **build**(`messageBuilder`, `cmd`, `success`, `message`): [`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`SetSessionValueReply`\>

Defined in: [src/common/web/api/session/SessionCommands.ts:76](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/session/SessionCommands.ts#L76)
...
[`SetSessionValueCommand`](SetSessionValueCommand.md)
...
[`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`SetSessionValueReply`\>
