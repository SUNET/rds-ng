# Class: RevokeAuthorizationCommand

Defined in: [src/common/web/api/authorization/AuthorizationCommands.ts:78](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/authorization/AuthorizationCommands.ts#L78)
...
If true, the token will be removed immediately; otherwise, it will be marked as invalid only
...
> **new RevokeAuthorizationCommand**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `RevokeAuthorizationCommand`
...
> `readonly` **auth\_id**: `string` = `""`

Defined in: [src/common/web/api/authorization/AuthorizationCommands.ts:80](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/authorization/AuthorizationCommands.ts#L80)

***

### force

> `readonly` **force**: `boolean` = `true`

Defined in: [src/common/web/api/authorization/AuthorizationCommands.ts:82](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/authorization/AuthorizationCommands.ts#L82)
...
Defined in: [src/common/web/api/authorization/AuthorizationCommands.ts:79](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/authorization/AuthorizationCommands.ts#L79)
...
> `static` **build**(`messageBuilder`, `userID`, `authID`, `force`, `chain`): [`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`RevokeAuthorizationCommand`\>

Defined in: [src/common/web/api/authorization/AuthorizationCommands.ts:87](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/authorization/AuthorizationCommands.ts#L87)
...
[`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`RevokeAuthorizationCommand`\>
