# Class: RevokeAuthorizationReply

Defined in: [src/common/web/api/authorization/AuthorizationCommands.ts:102](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/authorization/AuthorizationCommands.ts#L102)
...
> **new RevokeAuthorizationReply**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `RevokeAuthorizationReply`
...
> `static` **build**(`messageBuilder`, `cmd`, `success`, `message`): [`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`RevokeAuthorizationReply`\>

Defined in: [src/common/web/api/authorization/AuthorizationCommands.ts:106](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/authorization/AuthorizationCommands.ts#L106)
...
[`RevokeAuthorizationCommand`](RevokeAuthorizationCommand.md)
...
[`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`RevokeAuthorizationReply`\>
