# Class: RequestAuthorizationReply

Defined in: [src/common/web/api/authorization/AuthorizationCommands.ts:56](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/authorization/AuthorizationCommands.ts#L56)
...
> **new RequestAuthorizationReply**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `RequestAuthorizationReply`
...
> `static` **build**(`messageBuilder`, `cmd`, `success`, `message`): [`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`RequestAuthorizationReply`\>

Defined in: [src/common/web/api/authorization/AuthorizationCommands.ts:60](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/authorization/AuthorizationCommands.ts#L60)
...
[`RequestAuthorizationCommand`](RequestAuthorizationCommand.md)
...
[`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`RequestAuthorizationReply`\>
