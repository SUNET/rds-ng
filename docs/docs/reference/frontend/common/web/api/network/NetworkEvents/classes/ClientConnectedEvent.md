...
Defined in: [src/common/web/api/network/NetworkEvents.ts:13](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/network/NetworkEvents.ts#L13)
...
> **new ClientConnectedEvent**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `ClientConnectedEvent`
...
> `static` **build**(`messageBuilder`, `chain`): [`EventComposer`](../../../../core/messaging/composers/EventComposer/classes/EventComposer.md)\<`ClientConnectedEvent`\>

Defined in: [src/common/web/api/network/NetworkEvents.ts:17](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/network/NetworkEvents.ts#L17)
...
[`EventComposer`](../../../../core/messaging/composers/EventComposer/classes/EventComposer.md)\<`ClientConnectedEvent`\>
