...
Defined in: [src/common/web/api/network/NetworkCommands.ts:12](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/network/NetworkCommands.ts#L12)
...
> **new PingCommand**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `PingCommand`
...
> `readonly` **ping\_payload**: `string` = `"PING"`

Defined in: [src/common/web/api/network/NetworkCommands.ts:13](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/network/NetworkCommands.ts#L13)
...
> `static` **build**(`messageBuilder`, `chain`): [`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`PingCommand`\>

Defined in: [src/common/web/api/network/NetworkCommands.ts:18](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/network/NetworkCommands.ts#L18)
...
[`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`PingCommand`\>
