...
Defined in: [src/common/web/api/network/NetworkEvents.ts:26](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/network/NetworkEvents.ts#L26)
...
> **new ClientDisconnectedEvent**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `ClientDisconnectedEvent`
...
> `static` **build**(`messageBuilder`, `chain`): [`EventComposer`](../../../../core/messaging/composers/EventComposer/classes/EventComposer.md)\<`ClientDisconnectedEvent`\>

Defined in: [src/common/web/api/network/NetworkEvents.ts:30](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/network/NetworkEvents.ts#L30)
...
[`EventComposer`](../../../../core/messaging/composers/EventComposer/classes/EventComposer.md)\<`ClientDisconnectedEvent`\>
