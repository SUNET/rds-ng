...
Defined in: [src/common/web/api/network/NetworkCommands.ts:27](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/network/NetworkCommands.ts#L27)
...
> **new PingReply**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `PingReply`
...
> `readonly` **ping\_payload**: `string` = `"PONG"`

Defined in: [src/common/web/api/network/NetworkCommands.ts:28](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/network/NetworkCommands.ts#L28)
...
> `static` **build**(`messageBuilder`, `cmd`, `success`, `message`): [`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`PingReply`\>

Defined in: [src/common/web/api/network/NetworkCommands.ts:33](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/network/NetworkCommands.ts#L33)
...
[`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`PingReply`\>
