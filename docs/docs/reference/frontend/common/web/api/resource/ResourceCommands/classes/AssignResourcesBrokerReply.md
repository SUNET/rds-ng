# Class: AssignResourcesBrokerReply

Defined in: [src/common/web/api/resource/ResourceCommands.ts:40](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/resource/ResourceCommands.ts#L40)
...
> **new AssignResourcesBrokerReply**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `AssignResourcesBrokerReply`
...
> `static` **build**(`messageBuilder`, `cmd`, `success`, `message`): [`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`AssignResourcesBrokerReply`\>

Defined in: [src/common/web/api/resource/ResourceCommands.ts:44](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/resource/ResourceCommands.ts#L44)
...
[`AssignResourcesBrokerCommand`](AssignResourcesBrokerCommand.md)
...
[`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`AssignResourcesBrokerReply`\>
