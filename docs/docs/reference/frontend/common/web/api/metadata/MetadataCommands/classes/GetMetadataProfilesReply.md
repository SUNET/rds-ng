# Class: GetMetadataProfilesReply

Defined in: [src/common/web/api/metadata/MetadataCommands.ts:30](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/metadata/MetadataCommands.ts#L30)
...
> **new GetMetadataProfilesReply**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `GetMetadataProfilesReply`
...
> `readonly` **profiles**: [`MetadataProfileContainerList`](../../../../data/entities/metadata/MetadataProfileContainer/type-aliases/MetadataProfileContainerList.md) = `[]`

Defined in: [src/common/web/api/metadata/MetadataCommands.ts:33](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/metadata/MetadataCommands.ts#L33)
...
> `static` **build**(`messageBuilder`, `cmd`, `profiles`, `success`, `message`): [`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`GetMetadataProfilesReply`\>

Defined in: [src/common/web/api/metadata/MetadataCommands.ts:38](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/metadata/MetadataCommands.ts#L38)
...
[`GetMetadataProfilesCommand`](GetMetadataProfilesCommand.md)
...
[`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`GetMetadataProfilesReply`\>
