# Class: GetMetadataProfilesCommand

Defined in: [src/common/web/api/metadata/MetadataCommands.ts:15](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/metadata/MetadataCommands.ts#L15)
...
> **new GetMetadataProfilesCommand**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `GetMetadataProfilesCommand`
...
> `static` **build**(`messageBuilder`, `chain`): [`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`GetMetadataProfilesCommand`\>

Defined in: [src/common/web/api/metadata/MetadataCommands.ts:19](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/metadata/MetadataCommands.ts#L19)
...
[`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`GetMetadataProfilesCommand`\>
