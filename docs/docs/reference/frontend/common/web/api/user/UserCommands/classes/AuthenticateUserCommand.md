...
Defined in: [src/common/web/api/user/UserCommands.ts:17](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/user/UserCommands.ts#L17)
...
> **new AuthenticateUserCommand**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `AuthenticateUserCommand`
...
> `readonly` **user\_token**: [`UserToken`](../../../../data/entities/user/UserToken/interfaces/UserToken.md)

Defined in: [src/common/web/api/user/UserCommands.ts:18](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/user/UserCommands.ts#L18)
...
> `static` **build**(`messageBuilder`, `userToken`, `chain`): [`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`AuthenticateUserCommand`\>

Defined in: [src/common/web/api/user/UserCommands.ts:23](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/user/UserCommands.ts#L23)
...
[`UserToken`](../../../../data/entities/user/UserToken/interfaces/UserToken.md)
...
[`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`AuthenticateUserCommand`\>
