# Class: ListUserAuthorizationsCommand

Defined in: [src/common/web/api/user/UserCommands.ts:140](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/user/UserCommands.ts#L140)
...
> **new ListUserAuthorizationsCommand**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `ListUserAuthorizationsCommand`
...
> `static` **build**(`messageBuilder`, `chain`): [`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`ListUserAuthorizationsCommand`\>

Defined in: [src/common/web/api/user/UserCommands.ts:144](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/user/UserCommands.ts#L144)
...
[`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`ListUserAuthorizationsCommand`\>
