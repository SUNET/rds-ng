# Class: ListProjectJobsCommand

Defined in: [src/common/web/api/project/ProjectJobCommands.ts:18](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/project/ProjectJobCommands.ts#L18)
...
> **new ListProjectJobsCommand**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `ListProjectJobsCommand`
...
> `static` **build**(`messageBuilder`, `chain`): [`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`ListProjectJobsCommand`\>

Defined in: [src/common/web/api/project/ProjectJobCommands.ts:22](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/project/ProjectJobCommands.ts#L22)
...
[`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`ListProjectJobsCommand`\>
