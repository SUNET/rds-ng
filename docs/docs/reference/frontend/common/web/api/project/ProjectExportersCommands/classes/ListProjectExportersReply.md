# Class: ListProjectExportersReply

Defined in: [src/common/web/api/project/ProjectExportersCommands.ts:32](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/project/ProjectExportersCommands.ts#L32)
...
> **new ListProjectExportersReply**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `ListProjectExportersReply`
...
> `readonly` **exporters**: [`ProjectExporterDescriptor`](../../../../data/exporters/ProjectExporterDescriptor/classes/ProjectExporterDescriptor.md)[] = `[]`

Defined in: [src/common/web/api/project/ProjectExportersCommands.ts:35](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/project/ProjectExportersCommands.ts#L35)
...
> `static` **build**(`messageBuilder`, `cmd`, `exporters`, `success`, `message`): [`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`ListProjectExportersReply`\>

Defined in: [src/common/web/api/project/ProjectExportersCommands.ts:40](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/project/ProjectExportersCommands.ts#L40)
...
[`ListProjectExportersCommand`](ListProjectExportersCommand.md)

##### exporters

[`ProjectExporterDescriptor`](../../../../data/exporters/ProjectExporterDescriptor/classes/ProjectExporterDescriptor.md)[]
...
[`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`ListProjectExportersReply`\>
