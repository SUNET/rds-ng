# Class: InitiateProjectJobReply

Defined in: [src/common/web/api/project/ProjectJobCommands.ts:90](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/project/ProjectJobCommands.ts#L90)
...
> **new InitiateProjectJobReply**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `InitiateProjectJobReply`
...
> `static` **build**(`messageBuilder`, `cmd`, `success`, `message`): [`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`InitiateProjectJobReply`\>

Defined in: [src/common/web/api/project/ProjectJobCommands.ts:94](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/project/ProjectJobCommands.ts#L94)
...
[`InitiateProjectJobCommand`](InitiateProjectJobCommand.md)
...
[`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`InitiateProjectJobReply`\>
