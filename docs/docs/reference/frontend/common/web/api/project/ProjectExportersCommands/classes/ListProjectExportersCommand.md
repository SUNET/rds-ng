# Class: ListProjectExportersCommand

Defined in: [src/common/web/api/project/ProjectExportersCommands.ts:17](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/project/ProjectExportersCommands.ts#L17)
...
> **new ListProjectExportersCommand**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `ListProjectExportersCommand`
...
> `static` **build**(`messageBuilder`, `chain`): [`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`ListProjectExportersCommand`\>

Defined in: [src/common/web/api/project/ProjectExportersCommands.ts:21](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/project/ProjectExportersCommands.ts#L21)
...
[`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`ListProjectExportersCommand`\>
