...
Defined in: [src/common/web/api/project/ProjectCommands.ts:18](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/project/ProjectCommands.ts#L18)
...
> **new ListProjectsCommand**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `ListProjectsCommand`
...
> `static` **build**(`messageBuilder`, `chain`): [`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`ListProjectsCommand`\>

Defined in: [src/common/web/api/project/ProjectCommands.ts:22](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/project/ProjectCommands.ts#L22)
...
[`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`ListProjectsCommand`\>
