# Class: ListConnectorsReply

Defined in: [src/common/web/api/connector/ConnectorCommands.ts:30](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/connector/ConnectorCommands.ts#L30)
...
> **new ListConnectorsReply**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `ListConnectorsReply`
...
> `readonly` **connectors**: [`Connector`](../../../../data/entities/connector/Connector/classes/Connector.md)[] = `[]`

Defined in: [src/common/web/api/connector/ConnectorCommands.ts:33](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/connector/ConnectorCommands.ts#L33)
...
> `static` **build**(`messageBuilder`, `cmd`, `connectors`, `success`, `message`): [`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`ListConnectorsReply`\>

Defined in: [src/common/web/api/connector/ConnectorCommands.ts:38](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/connector/ConnectorCommands.ts#L38)
...
[`ListConnectorsCommand`](ListConnectorsCommand.md)

##### connectors

[`Connector`](../../../../data/entities/connector/Connector/classes/Connector.md)[]
...
[`CommandReplyComposer`](../../../../core/messaging/composers/CommandReplyComposer/classes/CommandReplyComposer.md)\<`ListConnectorsReply`\>
