...
Defined in: [src/common/web/api/connector/ConnectorEvents.ts:34](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/connector/ConnectorEvents.ts#L34)
...
### authorization\_private

> `readonly` **authorization\_private**: [`AuthorizationSettings`](../../../../data/entities/authorization/AuthorizationSettings/interfaces/AuthorizationSettings.md)

Defined in: [src/common/web/api/connector/ConnectorEvents.ts:42](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/connector/ConnectorEvents.ts#L42)

***

### authorization\_public

> `readonly` **authorization\_public**: [`AuthorizationSettings`](../../../../data/entities/authorization/AuthorizationSettings/interfaces/AuthorizationSettings.md)

Defined in: [src/common/web/api/connector/ConnectorEvents.ts:41](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/connector/ConnectorEvents.ts#L41)
...
Defined in: [src/common/web/api/connector/ConnectorEvents.ts:39](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/connector/ConnectorEvents.ts#L39)
...
Defined in: [src/common/web/api/connector/ConnectorEvents.ts:35](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/connector/ConnectorEvents.ts#L35)
...
Defined in: [src/common/web/api/connector/ConnectorEvents.ts:38](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/connector/ConnectorEvents.ts#L38)

***

### display\_name

> `readonly` **display\_name**: `string` = `""`

Defined in: [src/common/web/api/connector/ConnectorEvents.ts:37](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/connector/ConnectorEvents.ts#L37)
...
> `readonly` **logos**: [`ConnectorLogos`](../../../../data/entities/connector/Connector/classes/ConnectorLogos.md)

Defined in: [src/common/web/api/connector/ConnectorEvents.ts:47](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/connector/ConnectorEvents.ts#L47)

***

### metadata\_profiles

> `readonly` **metadata\_profiles**: [`MetadataProfileContainerList`](../../../../data/entities/metadata/MetadataProfileContainer/type-aliases/MetadataProfileContainerList.md) = `[]`

Defined in: [src/common/web/api/connector/ConnectorEvents.ts:51](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/connector/ConnectorEvents.ts#L51)
...
> `readonly` **options**: [`ConnectorOptions`](../../../../data/entities/connector/Connector/enumerations/ConnectorOptions.md) = `ConnectorOptions.Default`

Defined in: [src/common/web/api/connector/ConnectorEvents.ts:43](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/connector/ConnectorEvents.ts#L43)
...
> `static` **build**(`messageBuilder`, `connectorID`, `name`, `description`, `category`, `authorizationPublic`, `authorizationPrivate`, `options`, `logos`, `metadataProfiles`, `chain`): [`EventComposer`](../../../../core/messaging/composers/EventComposer/classes/EventComposer.md)\<`ConnectorAnnounceEvent`\>

Defined in: [src/common/web/api/connector/ConnectorEvents.ts:56](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/connector/ConnectorEvents.ts#L56)
...
[`AuthorizationSettings`](../../../../data/entities/authorization/AuthorizationSettings/interfaces/AuthorizationSettings.md)
...
[`ConnectorOptions`](../../../../data/entities/connector/Connector/enumerations/ConnectorOptions.md)

##### logos

[`ConnectorLogos`](../../../../data/entities/connector/Connector/classes/ConnectorLogos.md)

##### metadataProfiles

[`MetadataProfileContainerList`](../../../../data/entities/metadata/MetadataProfileContainer/type-aliases/MetadataProfileContainerList.md)
...
[`EventComposer`](../../../../core/messaging/composers/EventComposer/classes/EventComposer.md)\<`ConnectorAnnounceEvent`\>
