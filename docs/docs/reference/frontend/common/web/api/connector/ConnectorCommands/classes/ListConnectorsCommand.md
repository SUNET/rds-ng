# Class: ListConnectorsCommand

Defined in: [src/common/web/api/connector/ConnectorCommands.ts:15](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/connector/ConnectorCommands.ts#L15)
...
> **new ListConnectorsCommand**(`name`, `origin`, `sender`, `target`, `hops`, `trace`, `apiKey`): `ListConnectorsCommand`
...
> `static` **build**(`messageBuilder`, `chain`): [`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`ListConnectorsCommand`\>

Defined in: [src/common/web/api/connector/ConnectorCommands.ts:19](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/api/connector/ConnectorCommands.ts#L19)
...
[`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`ListConnectorsCommand`\>
