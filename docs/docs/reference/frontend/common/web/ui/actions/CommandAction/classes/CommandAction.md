# Abstract Class: CommandAction\<CmdType, CompType\>

Defined in: [src/common/web/ui/actions/CommandAction.ts:10](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/ui/actions/CommandAction.ts#L10)

Actions specific to ``Command`.

## Extends

- [`Action`](../../Action/classes/Action.md)\<`CmdType`, `CompType`\>

## Extended by

- [`FrontendCommandAction`](../../../../../../frontend/src/ui/actions/FrontendCommandAction/classes/FrontendCommandAction.md)

## Type Parameters

### CmdType

`CmdType` *extends* [`Command`](../../../../core/messaging/Command/classes/Command.md)

### CompType

`CompType` *extends* [`CommandComposer`](../../../../core/messaging/composers/CommandComposer/classes/CommandComposer.md)\<`CmdType`\>

## Constructors

### Constructor

> **new CommandAction**\<`CmdType`, `CompType`\>(`service`, `suppressDefaultNotifiers`): `CommandAction`\<`CmdType`, `CompType`\>
...
`CommandAction`\<`CmdType`, `CompType`\>
