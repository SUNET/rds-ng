# Abstract Class: Action\<MsgType, CompType\>

Defined in: [src/common/web/ui/actions/Action.ts:15](https://github.com/Sciebo-RDS/rds-ng/blob/9b7c190cc4aaf42711ecc0fce854b1587c853586/src/common/web/ui/actions/Action.ts#L15)
...
- [`CommandAction`](../../CommandAction/classes/CommandAction.md)
- [`EventAction`](../../EventAction/classes/EventAction.md)
...
`CompType` *extends* [`MessageComposer`](../../../../core/messaging/composers/MessageComposer/classes/MessageComposer.md)\<`MsgType`\>

## Constructors

### Constructor

> **new Action**\<`MsgType`, `CompType`\>(`service`, `suppressDefaultNotifiers`): `Action`\<`MsgType`, `CompType`\>
